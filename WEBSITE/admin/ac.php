...
if($ac == "delcm")
{
	include "include/comment/delcm.php";
}
if($ac == "duyetcm")
{
	include "include/comment/duyetcm.php";
}
 ...
 if($ac == "edittin")
 {
	 include "include/tintuc/edittin.php";
 }
if($a == "xledittin")
{
	include "incude/tintuc/xledit.php";
}
if($ac == "deltin")
{
	include "include/tintuc/deltintuc.php";
}
?>